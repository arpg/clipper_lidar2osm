...
if __name__ == "__main__":
    ...
    # T_21[0:3, 3] = np.random.uniform(low=-2, high=2, size=(3,))
    ...
    iparams.sigma = 1 # good practice to set sigma to 0.5 * epsilon
    iparams.epsilon = 2
    ...
    corr = o3d.geometry.LineSet.create_from_point_cloud_correspondences(model, data, A_sel)
